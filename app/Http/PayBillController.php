...
class AboutController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if($request->file('about_image')){
            ...
            $about_image_file->storeAs('public/img/','about_image.' . $about_image_file->getClientOriginalExtension());
            $about_settings->about_image = 'storage/img/about_image.' . $about_image_file->getClientOriginalExtension();
        }

        $about_settings->save();
        return redirect()->route('admin.about')->with('success',"About Seetings Data has been update successfully.");
