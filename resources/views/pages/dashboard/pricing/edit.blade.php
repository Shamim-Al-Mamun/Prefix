...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.pricing.all') }}">Pricing </a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            <li class="nav-item">
                <a href="{{ route('admin.pricing.edit', $pricings->id) }}">Edit Pricing</a>
            </li>
        </ul>
    </div>
    ...
    <form action="{{ route('admin.pricing.update', $pricings->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pricing_title" name="pricing_title"
                                value="{{ $pricings->pricing_title }}" placeholder="Type here">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="pricing_price_amount" name="pricing_price_amount"
                                value="{{ $pricings->pricing_price_amount }}" placeholder="Type here">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" id="pricing_price_desc" name="pricing_price_desc" placeholder="Type here">{{ $pricings->pricing_price_desc }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pricing_price_button_text"
                                name="pricing_price_button_text" value="{{ $pricings->pricing_price_button_text }}"
