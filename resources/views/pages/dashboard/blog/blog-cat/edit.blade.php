...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.blog.category.edit', $blogCategory->id) }}"> Edit Blog Category</a>
            </li>
        </ul>
    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="topic" name="topic" placeholder="Type here"
                                        value="{{ $blogCategory->topic }}">
                                </div>
