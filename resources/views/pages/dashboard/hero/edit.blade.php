...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.hero.edit', $hero->id) }}">Edit Slider</a>
            </li>
        </ul>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="tab-content mt-2 mb-3" id="pills-with-icon-tabContent">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                {{-- <div class="form-group">
                                    <label for="hero_sub_title">Hero Sub Title</label>
                                    <input type="text" class="form-control" id="hero_sub_title" name="hero_sub_title"
                                        value="{{ $hero->hero_sub_title }}">
                                </div> --}}
                                <div class="form-group">
                                    <label for="hero_title">Title</label>
                                    <input type="text" class="form-control" id="hero_title" name="hero_title"
                                        value="{{ $hero->hero_title }}" placeholder="Type here">
                                </div>
                                <div class="form-group">
                                    <label for="hero_text">Description</label>
                                    <textarea type="text" class="form-control" id="hero_text" name="hero_text" rows="6"
                                        placeholder="Type here (maximum 600 characters...)">{{ $hero->hero_text }}</textarea>
                                </div>

                                @if (!empty($hero->hero_thumbnail))
                                    <figure class="imagecheck-figure">
                                        <img src="{{ url($hero->hero_thumbnail) }}" alt="title" class="imagecheck-image">
                                    </figure>
                                @else
                                    <figure class="imagecheck-figure">
                    ...
                    <div class="tab-pane fade" id="slider_tab_two" role="tabpanel"
                        aria-labelledby="pills-home-tab-icon">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="hero_main_button">Button One Text</label>
                                    <input type="text" class="form-control" id="hero_main_button"
                                        name="hero_main_button" value="{{ $hero->hero_main_button }}" placeholder="Type here">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="hero_main_button_link"
                                            name="hero_main_button_link" value="{{ $hero->hero_main_button_link }}" placeholder="Type here">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="hero_main_button_two"
                                        name="hero_main_button_two" value="{{ $hero->hero_main_button_two }}" placeholder="Type here">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="hero_main_button_two_link"
                                            name="hero_main_button_two_link" value="{{ $hero->hero_main_button_link }}" placeholder="Type here">
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="hero_link_button"
                                                        name="hero_link_button" value="{{ $hero->hero_link_button }}">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="url" class="form-control"
                                                            ...
                                                            value="{{ $hero->hero_link_button_url }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="hero_link_button_two"
                                                        name="hero_link_button_two"
                                                        value="{{ $hero->hero_link_button_two }}">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="url" class="form-control"
                                                            ...
                                                            value="{{ $hero->hero_link_button_two_url }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ $hero->hero_link_button_three }}">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="url" class="form-control"
                                                            ...
                                                            name="hero_link_button_three_url"
                                                            value="{{ $hero->hero_link_button_three_url }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="hero_link_button_four"
                                                        name="hero_link_button_four"
                                                        value="{{ $hero->hero_link_button_four }}">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="url" class="form-control"
                                                            ...
                                                            name="hero_link_button_four_url"
                                                            value="{{ $hero->hero_link_button_four_url }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
