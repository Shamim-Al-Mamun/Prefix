...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.coverage.add') }}">Edit coverage area</a>
            </li>
        </ul>
    </div>

    <form action="{{ route('admin.coverage.area.update', $coverageArea->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title">Update coverage area</h4>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="city" name="city" value="{{ $coverageArea->city }}"
                                placeholder="Type here">
                        </div>

                        <div class="form-group">
                            <label for="district">District</label>
                            <input type="text" class="form-control" id="district" name="district" value="{{ $coverageArea->district }}"
                                placeholder="Type here">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="maps_iframe_code" name="maps_iframe_code"
                                value="{{ $coverageArea->maps_iframe_code }}"
