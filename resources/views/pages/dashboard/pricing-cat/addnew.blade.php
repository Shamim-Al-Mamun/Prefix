...
@section('content')
    <div class="page-header">
        <h4 class="page-title">Pricing Category</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.pricing-cat.all') }}">Pricing Categories</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            <li class="nav-item">
                <a href="{{ route('admin.pricing-cat.addnew') }}">Add New Category</a>
            </li>
        </ul>
    </div>

    <form action="{{ route('admin.pricing-cat.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="pricing_category_name">Category name</label>
