    <!-- Terms Condition Page Area -->
    <section class="ISPTemplateV1-policy-terms-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1 col-12">
                    <div class="ISPTemplateV1-policy-terms-content">
                        <div class="ISPTemplateV1-policy-terms-content-widget">
                            <h3 class="ISPTemplateV1-policy-terms-content-widget-title">
                                Consent
                            </h3>
                            <p class="ISPTemplateV1-policy-terms-content-widget-text">
                                By using our website, you hereby consent to our Privacy Policy
                                and agree to its terms.
                            </p>
                            <p class="ISPTemplateV1-policy-terms-content-widget-text m-0">
                        ...
                        <div class="ISPTemplateV1-policy-terms-content-widget">
                            ...
                            <ul class="ISPTemplateV1-policy-terms-content-list">
                        ...
                        <div class="ISPTemplateV1-policy-terms-content-widget">
                            <h3 class="ISPTemplateV1-policy-terms-content-widget-title">
                                Mobile Application Usage Privacy Policy
                            </h3>
                            <p class="ISPTemplateV1-policy-terms-content-widget-text">
                            ...
                            <ul class="ISPTemplateV1-policy-terms-content-list mg-top-20 m-0">
                                <li>
                        ...
                        <div class="ISPTemplateV1-policy-terms-content-widget">
                            ...
                            <ul class="ISPTemplateV1-policy-terms-content-list m-0">
                                <li>
